...
{
	ifstream in;
	in.open("D://Spring 2023//Assembly//First Project//Project.txt");
...
{
	ifstream in;
	in.open("D://Spring 2023//Assembly//First Project//Memory.txt");

	vector<int> values;
	vector<int> addresses;
	int v = -112563, a = -112563;				//Random
	while (!in.eof())
	{
		in >> v >> a;
		values.push_back(v);
